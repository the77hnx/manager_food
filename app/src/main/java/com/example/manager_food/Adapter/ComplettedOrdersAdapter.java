...
public class ComplettedOrdersAdapter extends RecyclerView.Adapter<ComplettedOrdersAdapter.ComplettedOrderViewHolder> {

    private final Context context;
    private final List<OrderItem> orderList;
    private final OnOrderClickListener onOrderClickListener;

    public ComplettedOrdersAdapter(Context context, List<OrderItem> orderList, OnOrderClickListener onOrderClickListener) {
    ...
    @NonNull
    @Override
    public ComplettedOrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.frag_completed_order, parent, false);
        return new ComplettedOrderViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ComplettedOrderViewHolder holder, int position) {
    ...
    static class ComplettedOrderViewHolder extends RecyclerView.ViewHolder {
        ...
        public ComplettedOrderViewHolder(View itemView) {
            super(itemView);
